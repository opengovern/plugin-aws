...
var DefaultEC2Preferences = []*golang.PreferenceItem{
	...
	{Service: "EC2Instance", Key: "ENASupport", Value: wrapperspb.String("Yes"), PossibleValues: []string{"Yes"}},
	...
	{Service: "EBSVolume", Key: "ExcludeVolumeTypes", Value: wrapperspb.String(""), PreventPinning: true},
...
var DefaultRDSPreferences = []*golang.PreferenceItem{
	...
	{Service: "RDSInstance", Key: "ExcludeRDSVolumeTypes", Value: wrapperspb.String(""), PreventPinning: true},
}
