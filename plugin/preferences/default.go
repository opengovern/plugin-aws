...
var DefaultEC2Preferences = []*golang.PreferenceItem{
	...
	{Service: "EC2Instance", Key: "MemoryBreathingRoom", IsNumber: true, Value: wrapperspb.String("10"), PreventPinning: true, Unit: "%"},
	...
	{Service: "EC2Instance", Key: "ExcludeBurstableInstances", Value: wrapperspb.String("Yes"), PreventPinning: true, PossibleValues: []string{"No", "Yes"}},
...
var DefaultRDSPreferences = []*golang.PreferenceItem{
	...
	{Service: "RDSInstance", Key: "MemoryBreathingRoom", IsNumber: true, Value: wrapperspb.String("10"), PreventPinning: true, Unit: "%"},
